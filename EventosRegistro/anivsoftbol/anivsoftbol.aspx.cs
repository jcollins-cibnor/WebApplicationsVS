...
public partial class anivsoftbol_anivsoftbol : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        SqlDSregistro.InsertCommand = "INSERT INTO anivsoftbol VALUES ('" + txtNombres.Text +
        "', '" + txtApellidos.Text +
        "', '" + txtCorreo.Text +
        "', '" + txtTelefono.Text +
        ...
        try
        {
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "scasillas@cibnor.mx", "eventos@cibnor.mx", "Softbol - Registro web", mensaje, "normal");
        }
        catch (Exception ex)
        {
        ...
        if (registroOk == 1)
        {
            Response.Redirect("~/RegistroOk.aspx?evento=anivsoftbol");
        }
