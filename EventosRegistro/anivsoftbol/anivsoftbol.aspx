<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivsoftbol.aspx.cs" Inherits="anivsoftbol_anivsoftbol" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_anivsoftbol.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">XL Aniversario - Torneo de softbol</p>
        </div>
...
<!-- FALTA REVISAR EL ESTILO DEL TITULO Y LOS LOGOS, ASI COMO EL INSERT EN LA TABLA NUEVA "anivsoftbol" Y REALIZAR PRUEBAS -->
