<%@ Page Language="C#" AutoEventWireup="true" CodeFile="crustaceos2016.aspx.cs" Inherits="crustaceos2016_crustaceos2016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_crustaceos2016.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="/*background-image:url(../_img/logo_crustaceos2016.png);*/ background-repeat:no-repeat; background-position:center;">
            <p id="lblTitulo">Aspectos te&oacute;ricos y aplicados al cultivo de crust&aacute;ceos dec&aacute;podos: reproducci&oacute;n y crecimiento</p>
        </div>
        ...
        <section id="sec1Datos">
            <div id="divDatos">
                ...
                <asp:DropDownList ID="ddlOcupacion" class="input46percent" runat="server" >
                    <asp:ListItem Value="...">Cargo...</asp:ListItem>
                    <asp:ListItem>Profesor</asp:ListItem>
                    <asp:ListItem>Tecnico</asp:ListItem>
                    <asp:ListItem>Alumno</asp:ListItem>
                    <asp:ListItem>Investigador</asp:ListItem>
                </asp:DropDownList>
                <asp:TextBox ID="txtInstitucion" class="input" runat="server" MaxLength="200" placeholder="Instituci&oacute;n de procedencia..." />
                <asp:TextBox ID="txtLugar" class="input" runat="server" MaxLength="200" placeholder="Lugar de origen..." />
                <br />
                <br />
