...
public partial class crustaceos2016_crustaceos2016 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") { 
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO crustaceos2016 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            ...
            OpbCorreo.enviarCorreo("-","-", txtCorreo.Text, "xgodinez@cibnor.mx", "crustaceos2016@cibnor.mx", "crustaceos2016 - Registro en linea", mensaje, "normal");

            // Para pruebas
            // OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "jcollins@cibnor.mx", "-", "Curso crustaceos2016 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=crustaceos2016");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/crustaceos2016/uploads");
