...
public partial class anivboliche_anivboliche : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        SqlDSregistro.InsertCommand = "INSERT INTO anivboliche VALUES ('" + txtNombres.Text +
        "', '" + txtApellidos.Text +
        "', '" + txtCorreo.Text +
        "', '" + txtTelefono.Text +
        ...
        try
        {
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "mdvazquez@cibnor.mx", "eventos@cibnor.mx", "Boliche - Registro web", mensaje, "normal");
        }
        catch (Exception ex)
        {
            OpbCorreo.enviarCorreo("-", "-", "jcollins@cibnor.mx", "-", "-",
                "Error softbol", "ex.Message: " + ex.Message + " - " + txtCorreo.Text + " - ex.InnerException.Message: " + ex.InnerException.Message, "normal");
        ...
        if (registroOk == 1)
        {
            Response.Redirect("~/RegistroOk.aspx?evento=anivboliche");
        }
