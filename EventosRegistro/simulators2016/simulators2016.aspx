<%@ Page Language="C#" AutoEventWireup="true" CodeFile="simulators2016.aspx.cs" Inherits="simulators2016_simulators2016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_simulators2016.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="background-image:url(../_img/logo_simulators2016.png); background-repeat:no-repeat; background-position:center;">
            <p id="lblTitulo">Computer simulators in conservation genetics</p>
        </div>
