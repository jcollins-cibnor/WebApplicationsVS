...
public partial class simulators2016_simulators2016 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") {
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO simulators2016 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtInstitucion.Text +
            "', '" + factura +
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "xgodinez@cibnor.mx", "simulators2016@cibnor.mx", "simulators2016 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=simulators2016");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/simulators2016/uploads");
