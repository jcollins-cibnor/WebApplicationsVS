...
public partial class anivkayak_anivkayak : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        SqlDSregistro.InsertCommand = "INSERT INTO anivkayak VALUES ('" + txtNombres.Text +
        "', '" + txtApellidos.Text +
        "', '" + txtCorreo.Text +
        "', '" + txtTelefono.Text +
        ...
        try
        {
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "acruz04@cibnor.mx", "eventos@cibnor.mx", "Kayak - Registro web", mensaje, "normal");
        }
        catch (Exception ex)
        {
        ...
        if (registroOk == 1)
        {
            Response.Redirect("~/RegistroOk.aspx?evento=anivkayak");
        }
