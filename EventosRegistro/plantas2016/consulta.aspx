<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consulta.aspx.cs" Inherits="plantas2016_consulta" %>
...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <br />
        Evento:
        <asp:Label ID="lblEventoId" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="18px" ForeColor="#333399" Text="plantas2016"></asp:Label>
        <br />
        <hr />
    </div>
    <div>
    ...
    <asp:SqlDataSource ID="SqlDSgeneral" runat="server" ConnectionString="<%$ ConnectionStrings:REGWEBConnectionString %>" SelectCommand="SELECT * FROM [plantas2016]">
    </asp:SqlDataSource>
    <br />
