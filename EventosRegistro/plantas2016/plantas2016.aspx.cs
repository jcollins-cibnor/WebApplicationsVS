...
public partial class plantas2016_plantas2016 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") {
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO plantas2016 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtInstitucion.Text +
            "', '" + factura +
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "xgodinez@cibnor.mx", "plantas2016@cibnor.mx", "plantas2016 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=plantas2016");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/plantas2016/uploads");
