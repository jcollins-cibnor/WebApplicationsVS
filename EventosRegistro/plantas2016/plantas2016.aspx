<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plantas2016.aspx.cs" Inherits="plantas2016_plantas2016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_plantas2016.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="background-image:url(../_img/logo_plantas2016.png); background-repeat:no-repeat; background-position:center;">
<%--            <p id="lblTitulo">Curso: estr&eacute;s oxidativo en salud y enfermedad</p>--%>
        </div>
