...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <br />
        Evento:
        <asp:Label ID="lblEventoId" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="18px" ForeColor="#333399" Text="cultivos2015"></asp:Label>
        <br />
        <hr />
    </div>
    <div>
    ...
    <asp:SqlDataSource ID="SqlDSgeneral" runat="server" ConnectionString="<%$ ConnectionStrings:REGWEBConnectionString %>" SelectCommand="SELECT * FROM [cultivos2015]">
    </asp:SqlDataSource>
    <br />
