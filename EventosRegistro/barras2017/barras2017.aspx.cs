...
public partial class barras2017_barras2017 : System.Web.UI.Page
{
...
#region Crear el comando para el UPDATE
        SqlDSregistro.InsertCommand = "INSERT INTO barras2017 VALUES ('" +
            nombres.Text + "', '" +
            apellidos.Text + "', '" +
            correo.Text + "', '" +
            institucion.Value + "', '" +
        ...
        // MANDAMOS EL CORREO
        Opb.enviarCorreo("-", "-", correo.Text, "-", "barras2017@cibnor.mx", "Barras 2017 - Registro en linea", mensaje, "normal");
        //Opb.enviarCorreo("-", "-", correo.Text, "jcollins@cibnor.mx", "jcollins@cibnor.mx", "Barras 2017 - Registro", mensaje, "normal"); // PRUEBAS

        Response.Redirect("~/RegistroOk.aspx?evento=barras2017");
