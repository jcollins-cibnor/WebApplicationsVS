<%@ Page Language="C#" AutoEventWireup="true" CodeFile="barras2017.aspx.cs" Inherits="barras2017_barras2017" %>
...
<head runat="server">
    <meta charset="utf-8"/>
    <title>Barras 2017 - Registro</title>
            ...
            <div class="col-md-12">
                ...
                <div class="media"><%-- DIV PARA EL TITULO CON IMAGEN A LA DERECHA --%>
                    <div class="media-body">
                        <h2 class="media-heading"> Código de Barras de la vida</h2>
                        <p>4ta. Reunión Nacional de la Red Temática</p>
                    </div>
                    <div class="media-right">
                        <img src="images/logo_barras.png" class="media-object" style="width:250px" />
                    </div>
                </div>
...
<%--                            <input class="form-control" type="text" id="correo" placeholder="Correo" />--%>
                    ...
                    <asp:Button id="btnEnviar" class="btn btn-primary btn-lg" type="submit" runat="server" Text="Enviar" OnClick="btnEnviar_Click" />
                        <%--<button class="btn btn-primary btn-lg" id="btnEnviar" type="submit" runat="server" onserverclick="btnEnviar_Click" >Enviar-</button>--%>
                    <button id="btnLoading" class="btn btn-lg btn-warning disabled hidden"><span class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></span> Enviando...</button>
                    <br /><br />
                </form>
                <footer class="modal-footer">                  
                    ...
                    <p>
                        <a href="#" target="_blank" style="color:#e8e8ec">O</a>
                        <br />
                    </p>
                </footer>
