...
public partial class genomica2017_genomica2017 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") {
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO genomica2017 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtInstitucion.Text +
            "', '" + factura +
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "xgodinez@cibnor.mx", "genomica2017@cibnor.mx", "genomica2017 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=genomica2017");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/genomica2017/uploads");
