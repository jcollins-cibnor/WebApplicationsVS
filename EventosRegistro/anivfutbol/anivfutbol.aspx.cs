...
public partial class anivfutbol_anivfutbol : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        SqlDSregistro.InsertCommand = "INSERT INTO anivfutbol VALUES ('" + txtNombres.Text +
        "', '" + txtApellidos.Text +
        "', '" + txtCorreo.Text +
        "', '" + txtTelefono.Text +
        ...
        try
        {
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "aalvarez04@cibnor.mx, csoto04@cibnor.mx", "eventos@cibnor.mx", "Futbol - Registro web", mensaje, "normal");
        }
        catch (Exception ex)
        {
        ...
        if (registroOk == 1)
        {
            Response.Redirect("~/RegistroOk.aspx?evento=anivfutbol");
        }
