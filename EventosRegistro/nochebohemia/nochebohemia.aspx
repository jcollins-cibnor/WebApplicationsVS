<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nochebohemia.aspx.cs" Inherits="nochebohemia_nochebohemia" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_nochebohemia.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">XL Aniversario - Noche bohemia</p>
        </div>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data" >
        <section id="sec1Datos">
            <div id="divDatos">
                ...
                <br />
                <br />
                <asp:TextBox ID="txtPresentar" class="input" runat="server" MaxLength="50" placeholder="Que deseas presentar?" />
                <asp:TextBox ID="txtRequerimientos" class="inputTextArea" runat="server" MaxLength="250" TextMode="MultiLine" Rows="3" placeholder="Requerimientos para tu presentaci&oacute;n..." />
                <br />
                <br />
