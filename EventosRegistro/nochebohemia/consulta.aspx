<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consulta.aspx.cs" Inherits="nochebohemia_consulta" %>
...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <br />
        Evento:
        <asp:Label ID="lblEventoId" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="18px" ForeColor="#333399" Text="nochebohemia" ></asp:Label>
        <br />
        <hr />
    </div>
    <div>
        <asp:GridView ID="grvConsulta" runat="server" DataSourceID="SqlDSgeneral" BackColor="White" BorderColor="#3366CC" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="presentar" HeaderText="presentar" SortExpression="presentar" />
                <asp:BoundField DataField="requerimientos" HeaderText="requerimientos" SortExpression="requerimientos" />
    ...
    <asp:SqlDataSource ID="SqlDSgeneral" runat="server" ConnectionString="<%$ ConnectionStrings:REGWEBConnectionString %>" SelectCommand="SELECT * FROM [nochebohemia]">
    </asp:SqlDataSource>
    <br />
