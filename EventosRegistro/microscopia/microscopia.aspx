<%@ Page Language="C#" AutoEventWireup="true" CodeFile="microscopia.aspx.cs" Inherits="microscopia_microscopia" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_microscopia.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">8vo. Curso básico de microscopía electrónica de barrido, Colección y manejo de imágenes digitales</p>
        </div>
...
<%--                    <h3>Datos para facturacion</h3>
    ...
    <footer>
        <p>
            ...
            Instituto Politécnico Nacional 195, Playa Palo de Santa Rita Sur; La Paz, B.C.S. México; C.P. 23096, Tel:(52) (612) 123-8484 Fax:(52) (612) 125-3625<br />
