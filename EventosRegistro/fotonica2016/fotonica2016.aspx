<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fotonica2016.aspx.cs" Inherits="fotonica2016_fotonica2016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_fotonica2016.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="background-image:url(../_img/logo_fotonica2016.png); background-repeat:no-repeat; background-position:center;">
            <p id="lblTitulo">Curso te&oacute;rico-pr&aacute;ctico de microscop&iacute;a fot&oacute;nica y fotograf&iacute;a digital</p>
        </div>
