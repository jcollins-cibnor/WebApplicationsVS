...
public partial class redesclim_redesclim : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        // Obtenemos el valor del checkbox "chkRequiereHospedaje" por medio del atributo "name"
        string hospedaje = (Request.Form["chkRequiereHospedaje"] != null) ? traslado = Request.Form["chkRequiereHospedaje"].ToString() : "NO";


        string msgBody =
             "- DATOS GENERALES" + '\n' +
            '\n' +
            "Nombre completo: " + pOpenTag + nombres.Value + " " + apellidos.Value + pCloseTag +
            "Correo electr&oacute;nico: " + pOpenTag + correo.Value + pCloseTag +
            institucion.Attributes["placeholder"] + ": " + pOpenTag + institucion.Value + pCloseTag +
            '\n' +
            "- ITINERARIO" + msgTraslado +
            '\n' +
            "Hospedaje: " + pOpenTag + hospedaje + pCloseTag +
        ...
        // MANDAMOS EL CORREO
        Opb.enviarCorreo("-", "-", correo.Value, "-", "redesclim@cibnor.mx", "REDESClim 2017 - Registro en linea", mensaje, "normal");
        //Opb.enviarCorreo("-", "-", correo.Value, "-", "jcollins@cibnor.mx", "REDESClim 2017 - Registro", mensaje, "normal"); // PRUEBAS
