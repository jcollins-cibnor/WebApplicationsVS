<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivbasquet.aspx.cs" Inherits="anivbasquet_anivbasquet" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_anivbasquet.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">XL Aniversario - Torneo de b&aacute;squetbol</p>
        </div>
...
<!-- FALTA REVISAR EL ESTILO DEL TITULO Y LOS LOGOS, ASI COMO EL INSERT EN LA TABLA NUEVA "anivbasquet" Y REALIZAR PRUEBAS -->
