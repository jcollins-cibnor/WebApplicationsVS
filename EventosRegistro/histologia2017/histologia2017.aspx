<%@ Page Language="C#" AutoEventWireup="true" CodeFile="histologia2017.aspx.cs" Inherits="histologia2017_histologia2017" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_histologia2017.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="/*background-image:url(../_img/logo_histologia2017.png);*/ background-repeat:no-repeat; background-position:center;">
            <p id="lblTitulo">Curso de Actualizaci&oacute;n de Histolog&iacute;a</p>
        </div>
