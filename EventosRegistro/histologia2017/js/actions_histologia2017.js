...
$(document).ready(function () {
    ...
    var ocupacion = document.getElementById('ddlOcupacion');
    ...
    $('#btnContinuar').click(function () {
        ...
        if (valCampo(nombre) && valEmail(email) && valCamposIguales(email, emailconfirma) && valCampo(comprobante)
            && valDropDownList(ocupacion) ) {
