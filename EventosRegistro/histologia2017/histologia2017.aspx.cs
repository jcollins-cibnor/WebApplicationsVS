...
public partial class histologia2017_histologia2017 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") { 
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO histologia2017 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtTelefono.Text +
            ...
            OpbCorreo.enviarCorreo("-","-", txtCorreo.Text, "xgodinez@cibnor.mx", "histologia2017@cibnor.mx", "histologia2017 - Registro en linea", mensaje, "normal");

            // Para pruebas
            // OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "jcollins@cibnor.mx", "-", "Curso histologia2017 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=histologia2017");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/histologia2017/uploads");
