...
public partial class ogms2016_ogms2016 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        //else { 
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO ogms2016 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtInstitucion.Text +
            "', '" + txtOcupacion.Text +
            ...
            lblHiddenMensaje.Text =
                ...
                "Cargo u ocupaci&oacute;n: " + txtOcupacion.Text + '\n' +
                '\n' +
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "-", "ogms2016@cibnor.mx", "OGMs2016 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=ogms2016");
        //}
    ...
    //    {
    //        // Indicamos la ruta
    //        string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/ogms2016/uploads");
