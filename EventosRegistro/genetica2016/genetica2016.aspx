<%@ Page Language="C#" AutoEventWireup="true" CodeFile="genetica2016.aspx.cs" Inherits="genetica2016_genetica2016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_genetica2016.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="background-image:url(../_img/logo_genetica2016.png); background-repeat:no-repeat; background-position:center;">
            <p id="lblTitulo">TRANSFORMACI&Oacute;N GEN&Eacute;TICA DE MICROALGAS PARA SU APLICACI&Oacute;N BIOTECNOL&Oacute;GICA</p>
        </div>
