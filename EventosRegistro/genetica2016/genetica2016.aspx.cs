...
public partial class genetica2016_genetica2016 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") {
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO genetica2016 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtInstitucion.Text +
            "', '" + factura +
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "xgodinez@cibnor.mx", "genetica2016@cibnor.mx", "genetica2016 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=genetica2016");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/genetica2016/uploads");
