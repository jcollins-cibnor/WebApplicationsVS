...
public partial class biorreactores2016_biorreactores2016 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (fileUpload != "ok") { 
            ...
            SqlDSregistro.InsertCommand = "INSERT INTO biorreactores2016 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtTelefono.Text +
            ...
            OpbCorreo.enviarCorreo("-","-", txtCorreo.Text, "xgodinez@cibnor.mx", "biorreactores2016@cibnor.mx", "biorreactores2016 - Registro en linea", mensaje, "normal");

            // Para pruebas
            // OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "jcollins@cibnor.mx", "-", "Curso biorreactores2016 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=biorreactores2016");
        }
    ...
    protected string adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/biorreactores2016/uploads");
