<%@ Page Language="C#" AutoEventWireup="true" CodeFile="biorreactores2016.aspx.cs" Inherits="biorreactores2016_biorreactores2016" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_biorreactores2016.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="/*background-image:url(../_img/logo_biorreactores2016.png);*/ background-repeat:no-repeat; background-position:center;">
            <p id="lblTitulo">Curso: Fundamentos Sobre Biorreactores, Diseño e Implementaci&oacute;n de Bioprocesos Aplicados a la Biotecnologia de Microalgas</p>
        </div>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data" >
        <section id="sec1Datos">
            <div id="divDatos">
                ...
                <asp:DropDownList ID="ddlOcupacion" class="input46percent" runat="server" >
                    <asp:ListItem Value="...">Ocupaci&oacute;n...</asp:ListItem>
                    <asp:ListItem>Estudiante CIBNOR</asp:ListItem>
                    <asp:ListItem>Estudiante externo</asp:ListItem>
                    <asp:ListItem>Trabajador de una empresa</asp:ListItem>
                    <asp:ListItem>Personal del CIBNOR</asp:ListItem>
                </asp:DropDownList>
