...
public partial class anivtochito_anivtochito : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        SqlDSregistro.InsertCommand = "INSERT INTO anivtochito VALUES ('" + txtNombres.Text +
        "', '" + txtApellidos.Text +
        "', '" + txtCorreo.Text +
        "', '" + txtTelefono.Text +
        ...
        try
        {
            ...
            OpbCorreo.enviarCorreo("-", "-", txtCorreo.Text, "hlatis04@cibnor.mx", "eventos@cibnor.mx", "Tochito - Registro web", mensaje, "normal");
        }
        catch (Exception ex)
        {
            OpbCorreo.enviarCorreo("-", "-", "jcollins@cibnor.mx", "-", "-",
                "Error tochito", "ex.Message: " + ex.Message + " - " + txtCorreo.Text + " - ex.InnerException.Message: " + ex.InnerException.Message, "normal");
        ...
        if (registroOk == 1)
        {
            Response.Redirect("~/RegistroOk.aspx?evento=anivtochito");
        }
