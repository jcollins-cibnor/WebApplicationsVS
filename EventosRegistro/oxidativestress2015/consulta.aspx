<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consulta.aspx.cs" Inherits="oxidativestress2015_consulta" %>
...
<form id="form1" runat="server">
    ...
    <div>
        ...
        <br />
        Evento:
        <asp:Label ID="lblEventoId" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="18px" ForeColor="#333399" Text="oxidativestress2015"></asp:Label>
        <br />
        <hr />
    </div>
    <div>
        <asp:GridView ID="grvConsulta" runat="server" DataSourceID="SqlDSgeneral" BackColor="White" BorderColor="#3366CC" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="autorPresenta" HeaderText="autorPresenta" SortExpression="autorPresenta" />
                <asp:BoundField DataField="autorParticipa" HeaderText="autorParticipa" SortExpression="autorParticipa" />
    ...
    <asp:SqlDataSource ID="SqlDSgeneral" runat="server" ConnectionString="<%$ ConnectionStrings:REGWEBConnectionString %>" SelectCommand="SELECT * FROM [oxidativestress2015]">
    </asp:SqlDataSource>
    <br />
