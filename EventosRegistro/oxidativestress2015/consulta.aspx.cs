...
public partial class oxidativestress2015_consulta : System.Web.UI.Page
{
    ...
    // FALTA INDICAR LA RUTA REAL DE LA CONSTANCIA, QUE SE ENCUENTRA EN "ABULON"
    protected void grvConsulta_SelectedIndexChanged(object sender, EventArgs e)
    {
        Session["liga"] = "http://200.23.162.100/registroWeb/oxidativestress2015/" + grvConsulta.SelectedRow.Cells[4].Text + ".pdf";
