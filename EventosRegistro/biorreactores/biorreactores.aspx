<%@ Page Language="C#" AutoEventWireup="true" CodeFile="biorreactores.aspx.cs" Inherits="biorreactores_biorreactores" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_biorreactores.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo" style="/*background-image:url(../_img/logo_biorreactores.png);*/ background-repeat:no-repeat; background-position:center;">
