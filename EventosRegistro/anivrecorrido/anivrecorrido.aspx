<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivrecorrido.aspx.cs" Inherits="anivrecorrido_anivrecorrido" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_anivrecorrido.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">XL Aniversario - Recorrido en bicicleta</p>
        </div>
