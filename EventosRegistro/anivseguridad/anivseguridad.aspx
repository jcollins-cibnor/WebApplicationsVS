<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivseguridad.aspx.cs" Inherits="anivseguridad_anivseguridad" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_anivseguridad.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">XL Aniversario - Actividad seguridad</p>
        </div>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data" >
        <section id="sec1Datos">
            <div id="divDatos">
                <h2>Datos personales de quien registra</h2>
