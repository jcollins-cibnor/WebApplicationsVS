...
public partial class politicas2015_politicas2015 : System.Web.UI.Page
{
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        if (numRegistros("politicas2015") < 16)
        {
            // Insertamos en la tabla
            SqlDSregistro.InsertCommand = "INSERT INTO politicas2015 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtInstitucion.Text +
            "', '" + txtFacturaRfc.Text +
            ...
            enviarCorreo("eventos.cibnor@cibnor.mx", txtCorreo.Text, "politicas2015@cibnor.mx", "-", "Recursos 2015 - Registro en linea", mensaje, "normal");
            //enviarCorreo("eventos.cibnor@cibnor.mx", txtCorreo.Text, "-", "-", "Recursos 2015 - Registro en linea", mensaje, "normal");

            Response.Redirect("~/RegistroOk.aspx?evento=politicas2015");
        }
        else { 
    ...
    protected int adjuntarArchivo()
    {
        ...
        {
            // Indicamos la ruta
            string path = HttpContext.Current.ApplicationInstance.Server.MapPath("~/politicas2015/uploads");
