<%@ Page Language="C#" AutoEventWireup="true" CodeFile="politicas2015.aspx.cs" Inherits="politicas2015_politicas2015" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_politicas2015.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">Evaluaci&oacute;n de pol&iacute;ticas p&uacute;blicas e instrumentos de pol&iacute;tica ambiental en M&eacute;xico</p>
            <p id="lblRegistroEnLinea">Registro en L&iacute;nea</p>
        </div>        
    ...
    <br />
    <footer>
        <p>Centro de investigaciones Biol&oacute;gicas del Noroeste S.C.</p>
        <p>Instituto Polit&eacute;cnico Nacional 195, Playa Palo de Santa Rita Sur; La Paz, B.C.S. M&eacute;xico; C.P. 23096, Tel:(52) (612) 123-8484 Fax:(52) (612) 125-3625<br />
            <asp:HyperLink ID="hlkUrlFooter" runat="server" NavigateUrl="http://www.cibnor.gob.mx/component/content/article/472"
                Target="_blank">Pol&iacute;tica de Privacidad</asp:HyperLink></p>
    </footer>
