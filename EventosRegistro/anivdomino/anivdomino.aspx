<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivdomino.aspx.cs" Inherits="anivdomino_anivdomino" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/actions_anivdomino.js"></script>
...
<div id="divContainer">
    <header>
        ...
        <div id="divTitulo">
            <p id="lblTitulo">XL Aniversario - Torneo de domin&oacute;</p>
        </div>
